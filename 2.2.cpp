...
int main(void)
{
    ...
    const int n = 100000; //размерность массивов

    int i;
    double time_spent;

    int* arr1 = new int[n]; //случайный массив
    int* arr2 = new int[n];//возрастающий массив
    int* arr3 = new int[n];//убывающий массив
    int* arr4 = new int[n];//возрастающий\убывающий массив
    int* arr = new int[n];//промежуточный массив
